...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{QUBLOG_SERVER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{QUBLOG_SERVER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
qublog_server_server.pl - Catalyst Testserver

=head1 SYNOPSIS

qublog_server_server.pl [options]
